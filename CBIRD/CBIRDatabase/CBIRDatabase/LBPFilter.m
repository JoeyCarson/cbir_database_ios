...
static NSString * const kernelCode = @"                                                                     \n"
                                      ...
                                      "    binPix += (binColor(i, cr, cC) * 16);   // 2^4 = 16                      \n"
                                      "    binPix += (binColor(i, br, cC) * 8);    // 2^3 = 8                       \n"
                                      "    binPix += (binColor(i, bc, cC) * 4);    // 2^2 = 4                       \n"
                                      "    binPix += (binColor(i, bl, cC) * 2);    // 2^1 = 2                       \n"
                                      "    binPix += (binColor(i, cl, cC) * 1);    // 2^0 = 1                       \n"
                                      "                                                                             \n"
